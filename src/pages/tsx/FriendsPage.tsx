...
export function FriendsPage() {
  ...
  const handleInvite = () => {
    ...
    // Формируем ссылку с параметром startapp для прямого открытия мини-приложения
    // startapp открывает мини-приложение напрямую, а start открывает бота
    const inviteLink = userId 
      ? `https://t.me/react_my_test_bot?startapp=${userId}`
