...
import { CounterPage } from './CounterPage' // Импортируем страницу со счетчиком
import './App.css'
...
function App() {
  ...
  // Состояние для навигации между страницами
  // 'home' - главная страница, 'counter' - страница со счетчиком
...
// --- УМНЫЙ FULLSCREEN ---
  ...
  // Функция для перехода на страницу счетчика
  const goToCounter = () => {
  ...
  // Условный рендеринг: показываем разные страницы в зависимости от currentPage
